...
if not os.path.exists('raw_data/df_travel.csv'):
    df.to_csv('raw_data/df_travel.csv',index=False, mode='w',encoding='utf-8')
else:
    df.to_csv('raw_data/df_travel.csv',index=False, mode='a',encoding='utf-8',header=False)
